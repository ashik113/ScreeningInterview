...
const config = new Configuration({
    apiKey: "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",
});
...
app.get("/", async (req, res) => {
    const prompt = `
    {
		"prompt": "give me software engineering HR questions. It is necessary to Return response in the following parsable JSON format:{\"Q\": \"question\", \"A\": \"answer\"}",
		"max_tokens": 2048,
		"temperature": 1
	}`;
